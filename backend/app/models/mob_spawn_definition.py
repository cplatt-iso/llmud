...
class MobSpawnDefinition(Base):
    ...
    respawn_delay_seconds: Mapped[int] = mapped_column(
        Integer,
        default=300,
        nullable=False,
    ...
    chance_to_spawn_percent: Mapped[int] = mapped_column(
        Integer,
        default=100,
        nullable=False,
    ...
    next_respawn_check_at: Mapped[Optional[datetime]] = mapped_column(
    ...
    roaming_behavior: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
